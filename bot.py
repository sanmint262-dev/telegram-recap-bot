...
async def start(
    ...
    welcome = (
        ...
        "📌 MP3 / Voice ဖိုင်ပို့ပြီး စတင်ပါ။"
    )
...
# =========================================================
# GEMINI REQUEST WITH SAFE RETRY
# =========================================================
    ...
    for attempt in range(
        ...
        try:
            ...
            if (
                ...
                raise RuntimeError(
                    "Gemini quota/rate limit ပြည့်နေပါတယ်။\n\n"
                    + error_text
                )

            # ------------------------------------------------
            # 404 = wrong/unavailable model
            # ------------------------------------------------
...
async def call_tts_server(
    ...
    if not audio_base64:
        ...
        raise RuntimeError(
            "TTS response does not contain audio_base64."
        )
...
async def create_thumbnail_prompt(
    recap_text
):
...
- strong foreground and background
- 16:9
- no text
- no subtitles
- no watermark
...
"""
    ...
    if not prompt:
        ...
        prompt = (
            ...
            "dramatic emotional characters, "
            "realistic faces, dramatic lighting, "
            "high detail, cinematic composition, "
            "16:9, no text, no subtitles, "
            "no watermark"
        )
...
# =========================================================
# GENERATE THUMBNAIL USING IMAGE URL
# =========================================================

async def send_thumbnail(
    update: Update,
