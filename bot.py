...
# IMPORTANT:
# Keep your current Gemini model here.
...
def friendly_gemini_error(error):
    ...
    if (
        ...
        return (
            "⚠️ Gemini API Free Quota ပြည့်သွားပါပြီ။\n\n"
            "📊 လက်ရှိ Gemini model:\n"
            f"{GEMINI_MODEL}\n\n"
            "⏳ Google API quota ပြန်ရတဲ့အချိန်အထိ "
            "ခဏစောင့်ပြီး ပြန်စမ်းပါ။\n\n"
            "❗ Code ပြဿနာမဟုတ်ပါဘူး။ "
            "Gemini API quota ကန့်သတ်ချက်ကြောင့် ဖြစ်တာပါ။"
        )
    ...
    if (
        ...
        return (
            "⚠️ Gemini Server လက်ရှိအချိန်မှာ "
            "အလုပ်များနေပါတယ်။\n\n"
            "⏳ ခဏစောင့်ပြီး MP3 ကို ပြန်ပို့ပါ။"
        )
    ...
    if (
        ...
        return (
            "❌ Gemini Model မတွေ့ပါ။\n\n"
            f"လက်ရှိ Model: {GEMINI_MODEL}\n\n"
            "GEMINI_MODEL ကို စစ်ပေးပါ။"
        )
...
async def handle_text(
    ...
    try:
        ...
        response = await generate_gemini(
            user_text
        )
...
Write the recap with clear paragraphs.
Use natural Myanmar punctuation.
...
"""
        ...
        #
        # IMPORTANT:
        # Only ONE Gemini request for the audio.
        # =================================================
        ...
        thumbnail_prompt = (
            ...
            "realistic movie characters, "
            "dramatic cinematic lighting, "
            "high detail, "
            "professional film poster composition, "
            "16:9, "
            "no text, "
            "no subtitles, "
            "no watermark"
